    ...
    public class Program
    {
        static void Main()
        {
            ...
            */
            ...
            IEnumerable<Teacher> teacher5 = new Teacher[0];

            Console.WriteLine("------Printing Teachers List-------");

            //Showing teachers list with IEnumerable
            Teacher teacher4 = new Teacher
            {
                TeacherId = 4,
                Name = "Mohala",
                ContactNumber = "011454545"
            };

            IEnumerable<Teacher> teachersList = new List<Teacher>()
            {
                teacher1,teacher3,teacher4
            };

            foreach (var teacher in teachersList)
            {
                Console.WriteLine(teacher.TeacherId + " : " + teacher.Name);
            }
        }
...
//Showing teachers list with a List

/*
IEnumerable<Teacher> teachersList = new List<Teacher>();
Console.WriteLine(teacher4);

foreach (var teacher in teacher4)
{
